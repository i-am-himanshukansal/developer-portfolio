...
// taiwlinf nde ex[ress github vscode dsa restapis ]
import tailwindcss from '../app/assets/svg/skills/tailwind.svg';
import nodejs from '../app/assets/svg/skills/nodejs.svg'; // for nodejs, express, dsa, restapis fallback
import github from '../app/assets/svg/skills/github.svg';
import vscode from '../app/assets/svg/skills/vscode.svg';
import restapi from '../app/assets/svg/skills/restapi.svg'; // separate & correct
import dsa from '../app/assets/svg/skills/dsa.svg'; // separate & correct
import express from '../app/assets/svg/skills/express.svg'; // separate & correct
